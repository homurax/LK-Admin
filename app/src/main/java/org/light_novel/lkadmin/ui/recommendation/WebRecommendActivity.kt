...
import kotlinx.android.synthetic.main.activity_web_recommend.*
...
class WebRecommendActivity : AppCompatActivity() {

    companion object {
        const val TAG = "WebRecommendActivity"
    }

    private val viewModel by lazy { ViewModelProvider(this).get(WebRecommendViewModel::class.java) }

    private lateinit var adapter: WebRecommendAdapter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adapter = WebRecommendAdapter(this, viewModel.recommends)
