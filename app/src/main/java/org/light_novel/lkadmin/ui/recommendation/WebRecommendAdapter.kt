...
class WebRecommendAdapter(val context: Context, private val recommends: List<Recommend>) :
    RecyclerView.Adapter<WebRecommendAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.web_recommend_item, parent, false)
